...
import com.yangz.bloblog.controller.vo.BlogListVO;
import com.yangz.bloblog.controller.vo.SimpleBlogListVO;
import com.yangz.bloblog.dao.*;
...
import com.yangz.bloblog.util.MarkDownUtil;
import com.yangz.bloblog.util.PageQueryUtil;
import com.yangz.bloblog.util.PageResult;
import com.yangz.bloblog.util.PatternUtil;
...
public class BlogServiceImpl implements BlogService {
    ...
    public String saveBlog(Blog blog) {
        ...
        if (blogCategory == null) {
            ...
            blog.setBlogCategoryName("默认分类(Default)");
        }
        else {
            //设置分类名称
    ...
    public String updateBlog(Blog blog) {
        ...
        if (blogCategory == null) {
            ...
            blogForUpdate.setBlogCategoryName("默认分类(Default)");
        }
        else {
            //设置博客分类名称
    ...
    public PageResult getBlogsPageByCategory(String categoryName, int page) {
        if (PatternUtil.validKeyword(categoryName)) {
            ...
            if ("默认分类(Default)".equals(categoryName) && blogCategory == null) {
    ...
    private BlogDetailVO getBlogDetailVO(Blog blog) {
        if (blog != null && blog.getBlogStatus() == 1) {
            ...
            if (blogCategory == null) {
                blogCategory = new BlogCategory();
                blogCategory.setCategoryId(0);
                blogCategory.setCategoryName("默认分类(Default)");
        ...
        if (!CollectionUtils.isEmpty(blogList)) {
            ...
            for (Blog blog : blogList) {
                ...
                if (blogCategoryMap.containsKey(blog.getBlogCategoryId())) {
                    ...
                    blogListVO.setBlogCategoryName("默认分类(Default)");
